-- KiroUi (modified for smooth corners & dark grey minimal)
local library = {}
local windowCount = 0
local sizes = {}
local listOffset = {}
...
function library:Window(name) 
    ...
    UiWindow.BackgroundColor3 = Color3.fromRGB(40, 40, 42)      -- dark grey window frame
    UiWindow.BorderColor3 = Color3.fromRGB(30, 30, 32)
    ...
    Header.BackgroundColor3 = Color3.fromRGB(55, 55, 57)        -- header background
    Header.BorderColor3 = Color3.fromRGB(30, 30, 32)
    ...
    HeaderText.BackgroundColor3 = Color3.fromRGB(40, 40, 42)
    ...
    HeaderText.TextColor3 = Color3.fromRGB(230, 230, 235)       -- light grey text
    ...
    Minimise.BackgroundColor3 = Color3.fromRGB(70, 70, 73)
    Minimise.BorderColor3 = Color3.fromRGB(30, 30, 32)
    ...
    Minimise.Text = "_"
    Minimise.TextColor3 = Color3.fromRGB(200, 200, 205)
    ...
    minCorner.Parent = Minimise

    Window.Name = "Window"
    Window.Parent = Header
    Window.BackgroundColor3 = Color3.fromRGB(35, 35, 37)        -- main window body
    Window.BorderColor3 = Color3.fromRGB(30, 30, 32)
    ...
    function functions:Button(name, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(50, 50, 53)
        Button.BorderColor3 = Color3.fromRGB(30, 30, 32)
    ...
    function functions:Label(text, color)
        local color = color or Color3.fromRGB(200, 200, 205)
        ...
        Label.Name = "Label"
        Label.Parent = Window
        Label.BackgroundColor3 = Color3.fromRGB(35, 35, 37)
        ...
        if type(color) == "boolean" and color then
            local rainbowConn
            rainbowConn = game:GetService("RunService").Stepped:Connect(function()
                local hue = tick() % 5 / 5
                Label.TextColor3 = Color3.fromHSV(hue, 1, 1)
                -- if label is destroyed, disconnect
    ...
    function functions:Toggle(text, on, callback)
        ...
        ToggleDescription.TextColor3 = Color3.fromRGB(235, 235, 240)
        ...
        ToggleButton.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        ToggleFiller.BackgroundColor3 = Color3.fromRGB(140, 140, 145)   -- subtle green-grey
        ToggleFiller.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        fillCorner.Parent = ToggleFiller
    ...
    function functions:Box(text, callback)
        ...
        TextBox.BackgroundColor3 = Color3.fromRGB(50, 50, 53)
        TextBox.BorderColor3 = Color3.fromRGB(30, 30, 32)
        TextBox.Position = UDim2.new(0, 99, 0, listOffset[winCount])
        TextBox.Size = UDim2.new(0, 95, 0, 26)
        TextBox.Font = Enum.Font.SourceSans
        TextBox.PlaceholderColor3 = Color3.fromRGB(180, 180, 185)
        TextBox.PlaceholderText = "..."
        TextBox.Text = ""
        TextBox.TextColor3 = Color3.fromRGB(235, 235, 240)
        TextBox.TextSize = 16.000
        TextBox.TextStrokeColor3 = Color3.fromRGB(235, 235, 240)
        ...
        BoxDescription.TextColor3 = Color3.fromRGB(235, 235, 240)
    ...
    function functions:Slider(text, min, max, default, callback)
        ...
        Slider.BackgroundColor3 = Color3.fromRGB(45, 45, 48)
        Slider.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        SliderButton.BackgroundColor3 = Color3.fromRGB(140, 140, 145)
        SliderButton.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        Current.TextColor3 = Color3.fromRGB(200, 200, 205)
        ...
        Description.TextColor3 = Color3.fromRGB(235, 235, 240)
        Description.TextSize = 16.000
        Description.ZIndex = 2 + zindex

        SilderFiller.Name = "SilderFiller"
        SilderFiller.Parent = Slider
        SilderFiller.BackgroundColor3 = Color3.fromRGB(140, 140, 145)   -- subtle fill
        SilderFiller.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        Min.TextColor3 = Color3.fromRGB(180, 180, 185)
        Min.TextSize = 14.000
        ...
        Max.TextColor3 = Color3.fromRGB(180, 180, 185)
        Max.TextSize = 14.000
        ...
        function slider:SetValue(value)
            ...
            local fraction = (value - min) / (max - min)   -- fixed: use (max-min) not max
            local xOffset = fraction * (Slider.Size.X.Offset - 5)
            SliderButton.Position = UDim2.new(0, xOffset , -1.33333337, 0);
            SilderFiller.Size = UDim2.new(0, xOffset, 0, 6)
            Current.Text = tostring(math.round(value))
        end
    ...
    function functions:Dropdown(text, buttons, callback, selective)
        ...
        Dropdown.BackgroundColor3 = Color3.fromRGB(50, 50, 53)
        Dropdown.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        Dropdown.TextColor3 = Color3.fromRGB(235, 235, 240)
        ...
        DownSign.Text = "^"
        DownSign.TextColor3 = Color3.fromRGB(200, 200, 205)
        ...
        DropdownFrame.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        DropdownFrame.ScrollBarImageColor3 = Color3.fromRGB(180, 180, 185)
        ...
        function dropFunctions:Button(name)
            ...
            Button_2.BackgroundColor3 = Color3.fromRGB(50, 50, 53)
            Button_2.BorderColor3 = Color3.fromRGB(30, 30, 32)
            Button_2.Position = UDim2.new(0, 6, 0, canvasSize + 1)
            Button_2.Size = UDim2.new(0, 170, 0, 26)
            Button_2.Selected = true
            Button_2.Font = Enum.Font.SourceSans
            Button_2.TextColor3 = Color3.fromRGB(235, 235, 240)
        ...
        function dropFunctions:Remove(name)
            ...
            for i, v in ipairs(children) do
                if v:IsA("TextButton") and v.Text == name then
                    ...
                    v:Destroy()
                    canvasSize = canvasSize - 27
                    -- shift remaining buttons up
                    for j = i, #children do
                        local btn = children[j]
                        if btn and btn:IsA("TextButton") then
                            btn.Position = UDim2.new(0, 6, 0, btn.Position.Y.Offset - 27)
                        end
                    end
                    DropdownFrame.CanvasSize = UDim2.new(0, 182, 0, canvasSize + 1)
                    if #DropdownFrame:GetChildren() < 8 then
    ...
    function functions:ColorPicker(name, default, callback)
        ...
        PickerDescription.TextColor3 = Color3.fromRGB(235, 235, 240)
        ...
        ColorPickerFrame.BackgroundColor3 = Color3.fromRGB(45, 45, 48)
        ColorPickerFrame.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        ToggleRGB.BackgroundColor3 = Color3.fromRGB(45, 45, 48)
        ToggleRGB.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        local togCorner2 = Instance.new("UICorner")
        togCorner2.CornerRadius = UDim.new(0, 11)
        togCorner2.Parent = ToggleRGB

        ToggleFiller_2.Name = "ToggleFiller"
        ToggleFiller_2.Parent = ToggleRGB
        ToggleFiller_2.BackgroundColor3 = Color3.fromRGB(140, 140, 145)
        ToggleFiller_2.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ...
        fillCorner2.Parent = ToggleFiller_2
        ...
        ClosePicker.BackgroundColor3 = Color3.fromRGB(45, 45, 48)
        ClosePicker.BorderColor3 = Color3.fromRGB(30, 30, 32)
        ClosePicker.Position = UDim2.new(0, 132, 0, 5)
        ClosePicker.Size = UDim2.new(0, 21, 0, 21)
        ClosePicker.Font = Enum.Font.SourceSans
        ClosePicker.Text = "X"
        ClosePicker.TextColor3 = Color3.fromRGB(235, 235, 240)
        ...
        if default and type(default) == "boolean" then
            ...
            ColorPicker.BackgroundColor3 = default or Color3.fromRGB(140, 140, 145)
        end

        Canvas.Name = "Canvas"
        Canvas.Parent = ColorPickerFrame
        Canvas.BackgroundColor3 = Color3.fromRGB(200, 200, 205)
        ...
        Color.BackgroundColor3 = Color3.fromRGB(200, 200, 205)
        ...
        ColorSlider.BackgroundColor3 = Color3.fromRGB(235, 235, 240)
        ColorSlider.BorderColor3 = Color3.fromRGB(235, 235, 240)
        ...
        function colorFuncs:UpdateColorPicker(color)
            if type(color) == "userdata" then
                ...
                -- You could also update the cursor and slider positions, but that's complex.
